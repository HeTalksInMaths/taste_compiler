...
const SECTIONS = [
  {
    ...
    title: "Scorer Marketplace",
    description: "Pay-to-reveal quality scorers. Preview score lift, then unlock the full report.",
    badge: "4 scorers live",
    badgeColor: "rgba(92,124,250,0.1)",
    badgeText: "rgb(145,167,255)",
  },
  {
    href: "/market-dynamics/simulations",
    title: "Persona Market Simulation",
    description: "Deterministic persona decision model across Singapore and US launch markets.",
    badge: "200 personas",
  ...
  },
  {
    ...
    title: "Methodology",
    description: "How we stress-test marketplace assumptions using synthetic personas before spending on real acquisition.",
    badge: "Nemotron",
  ...
  },
  {
    ...
    description: "Stripe integration status, revenue split model, checkout flow, and reveal state machine.",
    badge: "Stripe test",
    badgeColor: "rgba(107,114,128,0.1)",
    badgeText: "rgb(156,163,175)",
  },
];
